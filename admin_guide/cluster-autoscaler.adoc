...
include::admin_guide/topics/creating-LC-and-ASG-cluster-auto-scaler.adoc[leveloffset=+2]

include::admin_guide/topics/deploying-cluster-auto-scaler.adoc[leveloffset=+2]

include::admin_guide/topics/testing-auto-scaler.adoc[leveloffset=+2]

include::admin_guide/topics/creating-golden-images-cluster-auto-scaler.adoc[leveloffset=+2]
